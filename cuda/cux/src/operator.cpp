...
double PerformanceEvaluator::GetPotentialOccupancy(
  ...
  CUXLOG_INFO("V%d occupancy: %f", kernel_id, occupancy);
  return occupancy;
}

///////////////
// Operator
void Operator::PrintElapsedTime(const RunMode mode) const {
